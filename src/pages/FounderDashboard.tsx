...
- Put every important brand colour directly into safe CSS using hex, rgb, hsl, gradients or CSS variables. Do not rely on Tailwind configuration, JavaScript-generated colours, external icon libraries or runtime class generation. This lets StoYangu preserve the intended palette safely after sanitising the file.
