...
- Put every important brand colour directly into dependable CSS using hex, rgb, hsl, gradients or CSS variables. Do not rely on Tailwind configuration, JavaScript-generated colours, external icon libraries or runtime class generation. This keeps the intended palette stable wherever the storefront is opened.
