...
const marketingSchema = [
  ...
  { '@context': 'https://schema.org', '@type': 'Service', name: 'StoYangu online store setup and upkeep', areaServed: 'Kenya', serviceType: 'Online storefront design, product catalog and performance-based upkeep', description: 'A full store build worth KES 15,000 is free in exchange for a short TikTok video tagging StoYangu. At the end of each 30-day upkeep period, FREE applies at 0–7 orders and PRO costs KES 999 at 8 or more orders.', offers: [{ '@type': 'Offer', name: 'FREE — 0 to 7 orders per 30-day period', description: 'No upkeep payment is due when a 30-day period ends with seven orders or fewer.', price: '0', priceCurrency: 'KES' }, { '@type': 'Offer', name: 'PRO — 8 or more orders per 30-day period', description: 'KES 999 store upkeep is due when a 30-day period ends with more than seven orders.', price: '999', priceCurrency: 'KES' }] },
];
...
export default function MarketingPage() {
  ...
  return <div className="marketing-page">
    <Seo title="StoYangu" description="Beautiful online stores for Kenyan social-media sellers. Setup worth KES 15,000 is free for a TikTok video; each 30-day upkeep period is FREE at 0–7 orders and KES 999 on PRO at 8+ orders." canonical={canonical} schema={marketingSchema} />
    ...
    <main>
      <section className="hero-section">
        ...
        <motion.div className="hero-copy" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .7 }}>
          ...
          <div className="hero-offer"><span>A full store build: <s>KES 15,000</s></span><b>FREE kwako</b><small>Post a short TikTok about your new store and tag StoYangu. 7 orders au chini = FREE hio month. More than 7 = Ksh 999 upkeep hio month.</small></div>
          ...
          <div className="trust-row"><span><Check /> Full setup is free</span><span><Check /> Pay only after 7 orders</span><span><ShieldCheck /> Results-based upkeep</span></div>
        </motion.div>
      ...
      <section id="pricing" className="marketing-section pricing-section pricing-models"><div className="pricing-intro"><span className="eyebrow">Two simple 30-day outcomes</span><h2>Your orders decide.</h2><p>Your first 30 days is a normal upkeep period, and at its end we check how many orders your store received. The same check repeats every 30 days.</p><div className="setup-exchange"><Sparkles /><div><strong>Setup is free on both</strong><span>Your KES 15,000 store build is fully waived when you post a short TikTok about it and tag StoYangu.</span></div></div></div><div className="pricing-plans"><article className="plan-card plan-free"><div className="plan-top"><span>FREE</span><strong>KES 0</strong><small>upkeep for that period</small></div><div className="plan-threshold"><b>0–7</b><span>orders in 30 days</span></div><p><Check /> Seven orders or fewer? You pay nothing when that 30-day period ends.</p><p><Check /> Your beautiful storefront and product tools stay ready.</p></article><article className="plan-card plan-pro"><div className="plan-label">WHEN SALES GROW</div><div className="plan-top"><span>PRO</span><strong>KES 999</strong><small>upkeep for that period</small></div><div className="plan-threshold"><b>8+</b><span>orders in 30 days</span></div><p><Check /> More than seven orders? KES 999 upkeep becomes due when that 30-day period ends.</p><p><Check /> The fee supports the store, updates and ongoing help as you grow.</p></article><div className="pricing-plain-note"><ShieldCheck /><p><strong>No orders, no pressure.</strong> The setup deal is the same for everyone; only the order result at the end of each 30-day period decides FREE or PRO.</p></div><button className="button-primary pricing-apply" onClick={() => setApplyOpen(true)}>Apply for my store <ArrowRight /></button></div></section>
