...
const marketingSchema = [
  ...
  { '@context': 'https://schema.org', '@type': 'Service', name: 'StoYangu online store setup and upkeep', areaServed: 'Kenya', serviceType: 'Online storefront design, product catalog and performance-based upkeep', description: 'A full store build worth KES 15,000 is free in exchange for a short TikTok video tagging StoYangu. At the end of each 30-day upkeep period, FREE applies at 0–5 orders and PRO costs KES 999 at 6 or more orders.', offers: [{ '@type': 'Offer', name: 'FREE — 0 to 5 orders per 30-day period', description: 'No upkeep payment is due when a 30-day period ends with five orders or fewer.', price: '0', priceCurrency: 'KES' }, { '@type': 'Offer', name: 'PRO — 6 or more orders per 30-day period', description: 'KES 999 store upkeep is due when a 30-day period ends with more than five orders.', price: '999', priceCurrency: 'KES' }] },
];
...
export default function MarketingPage() {
  ...
  return <div className="marketing-page">
    <Seo title="StoYangu" description="Beautiful online stores for Kenyan social-media sellers. Setup worth KES 15,000 is free for a TikTok video; each 30-day upkeep period is FREE at 0–5 orders and KES 999 on PRO at 6+ orders." canonical={canonical} schema={marketingSchema} />
    ...
    <main>
      ...
      <section id="pricing" className="marketing-section pricing-section pricing-models"><div className="pricing-intro"><span className="eyebrow">Two simple 30-day outcomes</span><h2>Your orders decide.</h2><p>There is no 30-day free trial. Your first 30 days is a normal upkeep period, and at its end we check how many orders your store received. The same check repeats every 30 days.</p><div className="setup-exchange"><Sparkles /><div><strong>Setup is free on both</strong><span>Your KES 15,000 store build is fully waived when you post a short TikTok about it and tag StoYangu.</span></div></div></div><div className="pricing-plans"><article className="plan-card plan-free"><div className="plan-top"><span>FREE</span><strong>KES 0</strong><small>upkeep for that period</small></div><div className="plan-threshold"><b>0–5</b><span>orders in 30 days</span></div><p><Check /> Five orders or fewer? You pay nothing when that 30-day period ends.</p><p><Check /> Your beautiful storefront and product tools stay ready.</p></article><article className="plan-card plan-pro"><div className="plan-label">WHEN SALES GROW</div><div className="plan-top"><span>PRO</span><strong>KES 999</strong><small>upkeep for that period</small></div><div className="plan-threshold"><b>6+</b><span>orders in 30 days</span></div><p><Check /> More than five orders? KES 999 upkeep becomes due when that 30-day period ends.</p><p><Check /> The fee supports the store, updates and ongoing help as you grow.</p></article><div className="pricing-plain-note"><ShieldCheck /><p><strong>No orders, no pressure.</strong> The setup deal is the same for everyone; only the order result at the end of each 30-day period decides FREE or PRO.</p></div><button className="button-primary pricing-apply" onClick={() => setApplyOpen(true)}>Apply for my store <ArrowRight /></button></div></section>
