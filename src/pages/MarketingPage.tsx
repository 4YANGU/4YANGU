...
const marketingSchema = [
  ...
  { '@context': 'https://schema.org', '@type': 'Service', name: 'StoYangu online store setup and upkeep', areaServed: 'Kenya', serviceType: 'Online storefront design, product catalog and store upkeep', description: 'A full store build worth KES 15,000 is free in exchange for a short promo video tagging StoYangu (Video Yangu, Store Yangu). The first 30 days are free. After that, upkeep is KES 300 for every 30 days, paid on day 30 to continue.', offers: [{ '@type': 'Offer', name: 'Free setup — Video Yangu promo', description: 'The KES 15,000 store build is fully waived when the seller posts a short video about the new store and tags StoYangu.', price: '0', priceCurrency: 'KES' }, { '@type': 'Offer', name: 'First 30 days free', description: 'Every new store gets its first 30 days completely free.', price: '0', priceCurrency: 'KES' }, { '@type': 'Offer', name: 'KES 300 per 30 days', description: 'After the free first 30 days, upkeep is KES 300 for every 30 days. On day 30 the owner chooses to continue by paying KES 300 for the upcoming month.', price: '300', priceCurrency: 'KES' }] },
];
...
export default function MarketingPage() {
  ...
  useEffect(() => {
    document.querySelectorAll('script[type="application/ld+json"]').forEach((node) => { if (node.textContent?.includes('first 30 days')) node.remove(); });
  ...
  return <div className="marketing-page">
    <Seo title="StoYangu" description="Beautiful online stores for Kenyan social-media sellers. Setup worth KES 15,000 is free for a short promo video; your first 30 days are free, then upkeep is KES 300 for every 30 days." canonical={canonical} schema={marketingSchema} />
    ...
    <main>
      <section className="hero-section">
        ...
        <motion.div className="hero-copy" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .7 }}>
          ...
          <div className="hero-offer"><span>A full store build: <s>KES 15,000</s></span><b>FREE kwako</b><small>Post a short video about your new store and tag StoYangu. Your first 30 days are totally free. Then KES 300 for every 30 days.</small></div>
          ...
          <div className="trust-row"><span><Check /> Full setup is free</span><span><Check /> First 30 days free</span><span><ShieldCheck /> KES 300 per 30 days after</span></div>
        </motion.div>
      ...
      <section id="how" className="marketing-section steps-section">
        ...
        <div className="steps-grid">
          <article className="step-card step-dark"><span className="step-number">01</span><div className="step-visual"><img src="/images/seller-recording-shop.jpg" alt="Black woman recording a product-selling video on her phone" loading="lazy" decoding="async" /></div><div className="step-copy"><div className="step-icon"><Video /></div><h3>Unatengeneza video</h3><p>Post a short TikTok about your new store, tag StoYangu, and mention your store link so customers know where to browse.</p></div></article>
          <article className="step-card"><span className="step-number">02</span><div className="step-visual"><img src="/images/products-flatlay.jpg" alt="Fashion, watch and perfume products displayed together" loading="lazy" decoding="async" /></div><div className="step-copy"><div className="step-icon"><StoreIcon /></div><h3>Wanaona products zote</h3><p>They see jerseys, hoodies, polos, perfume and everything together in one beautiful shop.</p></div></article>
      ...
      <section id="get-store" className="get-store-section">
        ...
        <div className="get-store-copy"><span className="eyebrow light">Video Yangu, StoYangu</span><h2>Napata StoYangu aje?</h2><p className="section-lead">Get your whole store for totally free.</p>
          <ol className="number-list"><li><img src="/images/apply-phone.jpg" alt="Black business owner applying on her phone" /><b>1</b><div><strong>Apply for a store</strong><p>Finya “Apply.” Add your name and phone number, and you are done.</p></div></li><li><img src="/images/store-build-preview.jpg" alt="Products arranged into a polished online storefront" /><b>2</b><div><strong>Tutabuild store yako</strong><p>We build your complete store with your real products, then send it to you to review.</p></div></li><li><img src="/images/testimonial-recording.jpg" alt="Black woman posting a short TikTok about her new store" /><b>3</b><div><strong>Post your TikTok</strong><p>Share a short video about your new store and tag StoYangu. That video covers the full KES 15,000 setup.</p></div></li></ol>
          <button className="button-cream" onClick={() => setApplyOpen(true)}>Start my free store <ArrowRight /></button>
        </div>
      </section>

      <section id="pricing" className="marketing-section pricing-section pricing-models"><div className="pricing-intro"><span className="eyebrow">One simple price</span><h2>KES 300 for every 30 days.</h2><p>Your first 30 days are completely free. On day 30, you choose to continue by paying KES 300 to cover the upcoming month. That is all — no order counting, no surprises.</p><div className="setup-exchange"><Sparkles /><div><strong>Setup is still free</strong><span>Your KES 15,000 store build is fully waived through the Video Yangu, StoYangu promo: post a short video about your store and tag StoYangu.</span></div></div></div><div className="pricing-plans"><article className="plan-card plan-pro"><div className="plan-label">ONLY PLAN</div><div className="plan-top"><span>STOYANGU</span><strong>KES 300</strong><small>for every 30 days</small></div><div className="plan-threshold"><b>30</b><span>days free to start</span></div><p><Check /> Your first 30 days are completely free.</p><p><Check /> On day 30, pay KES 300 to continue for the next month.</p><p><Check /> Setup free — the KES 15,000 build is waived for your promo video.</p></article><div className="pricing-plain-note"><ShieldCheck /><p><strong>Simple and flat.</strong> No order counting and no plan changes — every store pays KES 300 for every 30 days after its free first month.</p><p><strong>If you don't pay on day 30:</strong> your store stays visible to customers — you never instantly lose business — but your product tools lock until you pay. Stores that remain unpaid can be fully disabled by StoYangu.</p></div><button className="button-primary pricing-apply" onClick={() => setApplyOpen(true)}>Apply for my store <ArrowRight /></button></div></section>
