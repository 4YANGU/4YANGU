...
const BUNDLED_ASSETS = new Set([
  ...
  '/images/products-flatlay.jpg', '/images/kenyan-seller.jpg', '/images/kito-hoodie.jpg', '/images/kito-logo.jpg', '/images/kito-set.jpg', '/images/kito-shoes.jpg', '/images/kito-toy.jpg',
...
const LOCAL_IMAGE_RULES = [
  ...
  [/round.?neck|t-?shirt|tee\b|shirt|apparel|clothing|collection|garment/i, '/images/products-flatlay.jpg'],
...
const pickLocalFallback = (path, alt) => {
  ...
  return '/images/products-flatlay.jpg';
};
