...
import originalHandler from '../server/track.js';
export default async function handler(req, res) {
  ...
  try { return await originalHandler(req, res); } catch (e) { return res.status(500).json({ error: 'Unable to record activity.' }); }
}
